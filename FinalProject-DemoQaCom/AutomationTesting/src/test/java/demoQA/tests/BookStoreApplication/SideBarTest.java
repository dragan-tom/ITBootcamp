...
public class SideBarTest extends BaseTest {
    ...
    @Test
    public void allSidebarMainMenuButtonsAreDisplayed() {
        Assert.assertEquals(hashCodeWebElements(sidebarPage.sidebarMainMenuButtons2), 489198668);
    }

    @Test
    public void sidebarMainMenuButtonsAreExpandable() throws InterruptedException {
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.brokenLinksElementsSubMenuButton));
        ...
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.practiceFormFormsSubMenuButton));
        ...
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.browserWindowsAlertSubMenuButton));
        ...
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.accordianWidgetsSubMenuButton));
        ...
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.sortableInteractionsSubMenuButton));
        ...
        Assert.assertFalse(isElementDisplayed1s(sidebarPage.loginBsaSubMenuButton));
